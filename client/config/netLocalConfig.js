(function()
{
	...
	define([], function()
	{
        ...
        CASE("api/public/getPost", TURN_ON, function(netParams)
        {
            var id = netParams.data.id;

            if(id === "bin")
            {
                return {
                    title: "BIN",
                    content: "about/md-bin"
                };
            }
            else
            {
                return {
                    title: "CLI",
                    content: "about/md-cli"
                };
            }
        });

        CASE("api/public/signin", TURN_ON, {}, "POST");

        CASE("api/public/signout", TURN_ON, {}, "POST");
        ...
        [
            {
                name: "天坑",
                addr: "武隆",
                icon: "work/img/wulongtiankeng.jpg",
        ...
        CASE("api/public/changePassword", TURN_ON, true, "POST");
